...
const routes = [
  ...
  },
  {
    ...
    description:
      "FilterTube – יוטיוב מסונן וכשר בעברית. 3 רמות סינון, מצב אודיו, נגן ברקע, הורדות ואפס פרסומות. האלטרנטיבה הכשרה והחוקית ליוטיוב פרוץ. 30 יום ניסיון חינם.",
    keywords:
    ...
    lead: "החלופה הכשרה, המסוננת והחוקית ליוטיוב פרוץ – 3 רמות סינון, מצב אודיו, נגן ברקע, הורדות ואפס פרסומות. 30 יום ניסיון חינם.",
    sections: [
      {
