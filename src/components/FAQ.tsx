...
const faqs = [
  ...
  },
  {
    ...
    a: "לילדים ולנוער אנחנו ממליצים על פתרון שלא ניתן להסרה, כדי שהסינון לא ייעלם באיפוס. הדרן הוא הבחירה הנפוצה ביותר אצל הורים, וכושר פליי מתאים מצוין למי שרוצה מכשיר שמיש עם חנות אפליקציות כשרה. אפשר גם להשתמש ביועץ הסינון באתר כדי לקבל התאמה לפי הגיל והשימוש.",
  },
  {
  ...
  },
  {
    ...
    a: "כן. פיתחנו את FilterTube – אפליקציית אנדרואיד ליוטיוב מסונן וכשר, עם שלוש רמות סינון, מנעול הורים, מצב שמע בלבד, נגינה ברקע וללא פרסומות. אפשר להוריד אותה בחינם מעמוד FilterTube באתר.",
  },
  {
