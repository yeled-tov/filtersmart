...
const faqs = [
  {
    ...
    a: "סינון בסיסי לאייפון, גלקסי ואנדרואיד עולה 20₪ בלבד. מערכת כושר פליי עולה 70₪. מערכות הדרן ועסקן עולות 300₪. צריבת גרסה לשיאומי Qin עולה 70₪.",
  },
  {
  ...
  },
  {
    ...
    a: "הדרן (300₪) – ההגנה ההרמטית ביותר, צריבה שלמה שלא ניתנת להסרה בשום צורה. עסקן (300₪) – סינון AI חכם עם צריבה עמוקה, מיועד לאנשי עסקים. כושר פליי (70₪) – חנות אפליקציות כשרה עם MDM, וואטסאפ מסונן ללא תמונות פרופיל. סינון בסיסי (20₪) – חסימת אתרים פשוטה ומהירה.",
  },
  {
  ...
  },
  {
    ...
    a: "כן! אנחנו מתמחים בסינון כל מכשירי סמסונג גלקסי: Galaxy S24, S23, S22, Galaxy A54, A34, A14, Galaxy Note ועוד. כל רמות הסינון זמינות – מסינון בסיסי ב-20₪ ועד הדרן ב-300₪.",
  },
];
