...
const Services = () => {
  ...
  return (
    <>
      <SEOHead
        title="שירותי סינון טלפון וצריבת גרסאות באשדוד – FilterPhone פילטר פון"
        description="מגוון שירותי סינון טלפון וצריבת גרסאות באשדוד: סינון בסיסי 20₪, כושר פליי 70₪, הדרן 300₪, עסקן 300₪, צריבת גרסה Qin 70₪. משווק מורשה ☎ 052-718-6881"
        path="/services"
        keywords="סינון טלפון אשדוד, התקנת הדרן אשדוד, כושר פליי התקנה, עסקן התקנה, צריבת גרסה לשיאומי קין, מחיר סינון טלפון, סינון בסיסי אשדוד"
      />
