...
const Contact = () => {
  ...
  return (
    <>
      <SEOHead
        title="צור קשר – FilterPhone פילטר פון סינון טלפון אשדוד"
        description="צרו קשר עם FilterPhone (פילטר פון) באשדוד לשירותי סינון טלפון מקצועיים. טלפון: 052-718-6881, רחוב חטיבת גבעתי 2."
        path="/contact"
        keywords="סינון טלפון אשדוד, פילטר פון"
      />
