...
const About = () => {
  return (
    <>
      <SEOHead
        title="אודות SmartFilter – סינון טלפון מקצועי באשדוד"
        description="SmartFilter – משווק מורשה של הדרן, עסקן וכושר פליי באשדוד. שירות סינון טלפון מקצועי ואמין."
        path="/about"
      />
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-3xl md:text-5xl font-heading font-bold text-foreground mb-6">
              אודות <span className="gradient-text">SmartFilter</span>
            </h1>
            <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
              SmartFilter הוקמה מתוך תשוקה להגנה דיגיטלית ומחויבות לשירות מקצועי. אנו משווק מורשה של המותגים המובילים בתחום הסינון – הדרן, עסקן וכושר פליי – ופועלים מאשדוד לשרת לקוחות מכל הארץ.
            </p>
